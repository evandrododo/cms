...
<head>
    ...
    <title>Neurônio Produtora - [CMS]</title>
</head>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <a href="videos.php">Vídeos Cadastrados</a>
                        </h3>
                    </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Link</th>
                                        <th>Fonte</th>
                                        <th><i class="glyphicon glyphicon-cog" aria-hidden="true"></i>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="./video.php?acao=show&idVideo=<?=$Video->getId()?>">
                                                <?=$Video->getTitulo()?></a>
                                        </td>
                                        <td>
                                        </td>
